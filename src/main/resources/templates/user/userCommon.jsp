    ...
    <aside>
        <div id="sidebar"  class="nav-collapse ">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <p class="centered"><a href="profile.html"><img src="../../static/user/assets/img/ui-sam.jpg" class="img-circle" width="60"></a></p>
            ...
            <div class="row">
                ...
                *********************************************************************************************************************************************************** -->
                ...
                <div class="col-lg-3 ds">
                    ...
                    <div class="desc">
                        <div class="thumb">
                            <img class="img-circle" src="../../static/user/assets/img/ui-danro.jpg" width="35px" height="35px" align="">
                        </div>
                        <div class="details">
                    ...
                    <div class="desc">
                        <div class="thumb">
                            <img class="img-circle" src="../../static/user/assets/img/ui-zac.jpg" width="35px" height="35px" align="">
                        </div>
                        <div class="details">
                    ...
                    <div class="desc">
                        <div class="thumb">
                            <img class="img-circle" src="../../static/user/assets/img/ui-sam.jpg" width="35px" height="35px" align="">
                        </div>
                        <div class="details">
